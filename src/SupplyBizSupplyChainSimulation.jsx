...
import { SupplyBiz_BLUE, SupplyBiz_YELLOW, SupplyBiz_ORANGE, TRUCK_SPEED, FORKLIFT_SPEED, WORKER_SPEED, lerp, generateId } from './utils/simulationUtils';
...
// Constants
// const SupplyBiz_BLUE = '#0071ce';
// const SupplyBiz_YELLOW = '#ffc220';
// const SupplyBiz_ORANGE = '#ff6900';
...
function SupplyBizSupplyChainSimulation() {
      ...
      <div className="bg-gradient-to-r from-blue-700 via-blue-800 to-blue-900 p-4 shadow-2xl">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-white text-3xl font-bold">SupplyBiz Supply Chain Command Center</h1>
...
export default SupplyBizSupplyChainSimulation;