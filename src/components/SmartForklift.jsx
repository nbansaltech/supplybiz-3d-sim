...
import { SupplyBiz_ORANGE, SupplyBiz_YELLOW, lerp } from '../utils/simulationUtils';
    ...
    >
      <group>
        <RoundedBox args={[0.8, 0.6, 1]} position={[0, 0.3, 0]} radius={0.05}>
          <meshStandardMaterial color={SupplyBiz_ORANGE} />
        </RoundedBox>
        ...
        <group position={[0, 0.5, 0.8]}>
          ...
          {carrying && (
            <Box args={[0.7, 0.7, 0.7]} position={[0, 0.4, 0.5]}>
              <meshStandardMaterial color={forklift.package?.priority === 'express' ? '#e74c3c' : SupplyBiz_YELLOW} />
