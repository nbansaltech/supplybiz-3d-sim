## **Project Title**
**SupplyBiz Smart Supply Chain Simulation**  
*Transforming Retail Supply Chains: From Inventory Management to Last Mile Delivery*

---

## **Overview**
This project is a visually rich, interactive simulation platform that models the entire SupplyBiz supply chain—from inventory management in distribution centers to last-mile delivery at retail stores. It leverages modern web technologies (React, react-three-fiber, SVG) and simulates real-time ML-driven decision-making for routing, scheduling, and anomaly detection.
...
## **Demo Value**
- **For SupplyBiz:** Demonstrates how digital twins and ML can optimize every step of the supply chain.
